...
#pragma mark -
#pragma mark - JXShopDetailHeaderIcon
@interface JXShopDetailHeaderIcon : UIImageView

@property (nonatomic,strong) UIImageView *statusImageView;

@end

@implementation JXShopDetailHeaderIcon
...
#pragma mark -
#pragma mark - JXShopDetailLevel
#define levelImageWidth 12
#define levelImageMargin 2.5
@interface JXShopDetailLevel : UIView
...
@implementation JXShopDetailLevel
...
#pragma mark -
#pragma mark - JXShopDetailHeaderView
@interface JXShopDetailHeaderView ()

@property (nonatomic,strong) UIImageView *bgImageView;
@property (nonatomic,strong) JXShopDetailHeaderIcon *headerIcon;
@property (nonatomic,strong) UILabel *nameLabel;
@property (nonatomic,strong) JXShopDetailLevel *levelView;
...
@implementation JXShopDetailHeaderView
...
- (instancetype)init{
    ...
    if(self){
        ...
        _headerIcon = [[JXShopDetailHeaderIcon alloc]init];
        ...
        _levelView = [[JXShopDetailLevel alloc]init];
