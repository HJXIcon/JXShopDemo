//
//  JXShopProductCollectionViewCell.m
//  JXShopDemo
//
...
@interface JXShopProductCollectionViewCell ()
...
@implementation JXShopProductCollectionViewCell

- (instancetype)initWithFrame:(CGRect)frame{
    self = [super initWithFrame:frame];
    if(self){
        if(!_viewModel){
            _viewModel = [[JXShopProductCollectionCellViewModel alloc]init];
        }
